...
const String BaseAudioProcessor::getProgramName (int index)
{
    return {};
}
...
void BaseAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* BaseAudioProcessor::createEditor()
{
    return new BaseAudioProcessorEditor (*this);
}

//==============================================================================
void BaseAudioProcessor::getStateInformation (MemoryBlock& destData)
{
